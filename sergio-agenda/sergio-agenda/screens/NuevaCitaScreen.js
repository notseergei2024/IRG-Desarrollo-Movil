...
export default function NuevaCitaScreen({
  visible,
  cita,           // null = nueva, objeto = edición
  fechaInicial,   // 'YYYY-MM-DD' opcional para precargar la fecha
  onClose,
  onGuardado
}) {
...
function Campo({ label, children, estilo }) {
  return (
...
function formatearFechaLarga(iso) {
  ...
  const loc = LocaleConfig.locales['es'] || LocaleConfig.locales[''];
  if (!loc) return iso;
